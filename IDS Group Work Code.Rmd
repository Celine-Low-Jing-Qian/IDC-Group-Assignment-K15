...
# 1. Average Year-on-Year GDP per Capita Growth by Continent 
...
# 2. LDC GDP Change According to Continent 
## Asia 
...
# 2. Compute year-on-year GDP per capita growth (%) for each country
...
# Filter North America (2015–present)
...
# Filter South America (2015–present)
